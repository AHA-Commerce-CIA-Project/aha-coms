...
> **Status: SHIPPED end-to-end (PRs A → E) on 2026-05-03.** Spec-update sweep (PR F) in flight; Heroes-side rev3 unblocks on F's merge.
>
...
> - **PR F — pending.** Initial spec-update sweep landed alongside PR A; this sweep marks Spec 06 shipped end-to-end and updates spec-01 / spec-03 / heroes-integration-handoff / spec-00 references. Heroes-side rev3 work unblocks once F lands.
>
