...
| 06 | Dual-Email Auth (workspace OIDC + personal OTP) | Portal | PRs A/B1/B2/C shipped 2026-04-30 → 2026-05-01 (commits `049008d`, `6938553`, `ac2f905`, `df1c90c`+`6f96634`); PRs D–E pending; PR F (spec sweep) pending | Minimal — Heroes compiles unchanged against `@coms-portal/shared` v1.5.0; no required Heroes work until PR F lands | **Yes — blocks Heroes-side rev3 adoption** |
