...
| 07 | Org Taxonomies & Employment Block (`@coms-portal/shared` v1.6.0 contract bump) | Portal | Drafted 2026-05-04. PR 07-1 SHIPPED 2026-05-04 (commit `26057ec`) — schema + seed + manifest v2 + cutover rollback companion. PRs 07-2 → 07-5 remaining (~4-5 days). | No (sets up the contract Heroes consumes in Spec 08) | **Yes — precondition for Spec 08 + every future H-app onboarding** |
