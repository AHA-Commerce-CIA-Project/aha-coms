...
- Connection pooling: Cloud Run instances use `postgres` (Postgres.js) with a small connection pool sized for serverless (`max: 5` or similar). Cloud SQL connection limits apply.
