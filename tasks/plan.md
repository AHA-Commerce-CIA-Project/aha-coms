...
> Last updated: 2026-05-12 (Checkpoint 4 crossed; CP4 Findings settled; FU-1 + FU-2 prod-applied + dashboard-verified — HEROES card flipped green at 08:05:23 UTC; FU-4 closed — `infra/README.md` runbook written; FU-3 next — migration automation in `deploy-portal-api.yml`)
