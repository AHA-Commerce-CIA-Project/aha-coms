...
"dependencies": {
  "@coms-portal/account-widget-svelte": "file:../../../coms-account-widget"
}
```
...
```ts
import { signOut } from '@coms-portal/account-widget-svelte'
...
@import "@coms-portal/account-widget-svelte/styles.css";
